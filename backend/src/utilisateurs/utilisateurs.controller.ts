...
export class UtilisateursController {
  ...
  @Patch(':id')
  update(@Param('id') id_utilisateur: string, @Body() updateUtilisateurDto: UpdateUtilisateurDto) {
    return this.utilisateursService.update(id_utilisateur, updateUtilisateurDto);
  }
